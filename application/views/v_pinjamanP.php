        ...
        <div class="box-header with-border">
          ...
          <div class="table-responsive">
            <table id="example1" class=" table table-bordered table-hover  dataTable dataAdmin ">
              ...
              <tbody>
                ...
                foreach ($data as $d) {
                  ...
                  <tr>
                    ...
                    <td class="dataRP"><?php echo 'Rp. ' . number_format( $d['pinjaman'], 0 , '' , '.' ) . ',-'; ?></td>
                    <td><?php echo $d['lama']; ?></td>
                    <td><?php echo $d['setoranke']; ?></td>
                    <td class="dataRP"><?php echo 'Rp. ' . number_format( $d['sisa'], 0 , '' , '.' ) . ',-'; ?></td>
                    <td><a href="<?php echo base_url()."index.php/Ctrl_pinjamanP/detailPinjamanA/".$d['idPinjaman'];?>">Detail</a></td>
                    <td><a href="<?php echo base_url()."index.php/Ctrl_pinjamanP/updatePinjaman/".$d['idPinjaman'];?>">Update</a></td>
                    <td><a href="<?php echo base_url()."index.php/Ctrl_pinjamanP/nonaktif/".$d['idAnggota'];?>" onclick="return confirmDelete();" >Selesai</a></td>
             ...
             <a href="<?php echo base_url()."index.php/Ctrl_pinjamanP/addPinjamanA";?>" class="btn btn-block btn-primary">Tambah Pinjaman</a>
           </div>
          </div>
...
<script>
  $(function () {
   ...
   function confirmDelete() {
        return confirm('Anda yakin pinjaman telah selesai?');
    }
</script>
</body>
</html>
