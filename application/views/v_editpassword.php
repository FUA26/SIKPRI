    ...
    <div class="col-md-4 col-md-push-4 col-sm-12">
      <div class="box box-success">
        <div class="box-header with-border">
          <div class="warp-isi">
            <div> <h4><strong> Ganti Kata Sandi</strong></h4></div>
            <form action="<?php echo base_url()."index.php/Ctrl_anggotaA/updatePassword/".$this->session->userdata("idUser");?>" method="post">
              <div class="form-group mb-lg">
                <label>Password Lama</label>
                <div class="input-group ">
                  <input name="lama" type="password" class="form-control input-lg" required autofocus>
              ...
              <div class="form-group mb-lg">
                ...
                <div class="input-group">
                  <input name="baru" type="password" class="form-control input-lg" id="password" required>
