      ...
      <div class="box box-success">
         ...
         <div class="statusUpdate ">
          ...
          <div class="table-responsive">
            <table id="example2" class=" table table-bordered table-hover  dataTable">
              ...
              <tbody>
                <tr>
                  <td class="dataRp"><?php echo 'Rp. ' . number_format( $pokok, 0 , '' , '.' ) . ',-'; ?></td>
                  <td class="dataRp"><?php echo 'Rp. ' . number_format( $wajib, 0 , '' , '.' ) . ',-'; ?></td>
                  <td class="dataRp"><?php echo 'Rp. ' . number_format( $gertab, 0 , '' , '.' ) . ',-'; ?></td>
                  <td class="dataRp"><?php echo 'Rp. ' . number_format( $thr, 0 , '' , '.' ) . ',-'; ?></td>
                  <td class="dataRp"><?php echo 'Rp. ' . number_format( $manasuka, 0 , '' , '.' ) . ',-'; ?></td>
                  <td class="dataRp"><?php echo 'Rp. ' . number_format( $total, 0 , '' , '.' ) . ',-'; ?></td>
                </tr>
              </tr>
            </tbody>
        ...
        <div class="riwayat">
          <button type="button" class="btn bg-olive margin">
            <a href="<?php echo base_url()."index.php/Ctrl_simpananA/detail_simpanan/";?>">  Detail Simpanan</a>
          </button>
        </div>
      </div>
