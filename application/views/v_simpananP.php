              ...
              <tbody>
                ...
                foreach ($data as $d) {
                  ...
                  <tr>
                    ...
                    <td><a href="<?php echo base_url()."index.php/Ctrl_simpananP/detailSimpananA/".$d['idAnggota'];?>">Detail</a></td>
                    <td><a href="<?php echo base_url()."index.php/Ctrl_simpananP/updateSimpananA/".$d['idAnggota'];?>">Update</a></td>
