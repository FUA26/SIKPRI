      ...
      <div class="box box-danger">
        <div class="box-header with-border">
                ...
                foreach ($data as $d) {
                  ...
                  <tr>
                    ...
                    <td><?php
                     ...
                     ?></td>
                    <td><a href="<?php echo base_url()."index.php/Ctrl_pengajuanP/detail/".$d['idPengajuan'];?>">Detail</a></td>
                    <td><a href="<?php echo base_url()."index.php/Ctrl_pengajuanP/terima/".$d['idPengajuan'];?>"  onclick="return confirmTerima();">Terima</a>
                    |
                    <a href="<?php echo base_url()."index.php/Ctrl_pengajuanP/tolak/".$d['idPengajuan'];?>"  onclick="return confirmTolak();" >Tolak</a></td>
                    <td><a href="<?php echo base_url()."index.php/Ctrl_pengajuanP/nonaktif/".$d['idPengajuan'];?>"  onclick="return confirmSelesai();" >Selesai</a></td>
          ...
          <div class="col-sm-offset-1 col-sm-3">
             <a href="<?php echo base_url()."index.php/Ctrl_pengajuanP/pengajuanNa";?>" class="btn btn-warning btn-block ">Daftar pengajuan selesai</a>
           </div>
          </div>
...
<script>
  $(function () {
   ...
   function confirmTerima() {
        return confirm('Anda yakin menerima pengajuan pinjaman?');
    }
     function confirmTolak() {
        return confirm('Anda yakin menolak pengajuan pinjaman?');
    }
     function confirmSelesai() {
        return confirm('Anda yakin pengajuan pinjaman telah selesai?');
    }
</script>
</body>
</html>
