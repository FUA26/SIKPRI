  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
     ...
     <li>
      ...
      <li class="active">
        <a href="<?php echo base_url()."index.php/Ctrl_pinjamanP/pinjaman"?>">
          ...
          <div class="box-header with-border">
            <div class="statusUpdate ">
              <p>Data pada : <?php 
                ...
                echo date("Y-m-d h:i:sa"); ?></p></div>            <div class="table-responsive">
                 <table id="example2" class=" table table-bordered table-hover  dataTable">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="dataRp"><?php echo 'Rp. ' . number_format( $pinjaman, 0 , '' , '.' ) . ',-' ; ?></td>
                      <td><?php echo $lama; ?></td>
                      <td class="dataRp"><?php echo 'Rp. ' . number_format(  $potongan, 0 , '' , '.' ) . ',-'; ?></td>
                      <td><?php echo $setoranke; ?></td>
                      <td class="dataRp"><?php echo 'Rp. ' . number_format( $sisa, 0 , '' , '.' ) . ',-' ; ?></td>
                    </tr>
                  </tr>
                </tbody>
            ...
            <div class="riwayat">
              <button type="button" class="btn bg-olive margin">
                <a href="<?php echo base_url()."index.php/Ctrl_pinjamanA/detail_pinjaman/".$idPinjaman;?>">  Detail Pinjaman</a>
              </button>
            </div>
          </div>
