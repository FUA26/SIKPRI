      ...
      <div class="box box-danger">
        <div class="box-header with-border">
          <div class="table-responsive">
            <div class="warp-isi" >
              <div> <h4><strong>Detail Simpanan</strong></h4></div>
            </div>
            <table id="passif" class=" table table-bordered table-hover  dataTable dataAdmin">
              <thead>
                <tr role="row">
                  <th>Nama</th>
                  <th>Pokok</th>
              ...
              <tbody>
                <tr>
                  <td ><?php echo $data2[0]['nama']; ?></td>
                  <td class="dataRp"><?php echo 'Rp. ' . number_format( $data2[0]['pokok'], 0 , '' , '.' ) . ',-' ; ?></td>
                  <td class="dataRp"><?php echo 'Rp. ' . number_format( $data2[0]['wajib'], 0 , '' , '.' ) . ',-' ; ?></td>
                  <td class="dataRp"><?php echo 'Rp. ' . number_format( $data2[0]['gertab'], 0 , '' , '.' ) . ',-' ; ?></td>
                  <td class="dataRp"><?php echo 'Rp. ' . number_format( $data2[0]['thr'], 0 , '' , '.' ) . ',-' ;  ?></td>
                  <td class="dataRp"><?php echo 'Rp. ' . number_format( $data2[0]['manasuka'], 0 , '' , '.' ) . ',-' ; ?></td>
                  <td class="dataRp"><?php echo 'Rp. ' . number_format( $data2[0]['total'], 0 , '' , '.' ) . ',-' ; ?></td>
    ...
    <div class="col-md-12">
      <div class="box box-danger">
        <div class="box-header with-border">
          <div class="table-responsive">
            <div class="warp-isi" >
              <div> <h4><strong>Detail Setoran</strong></h4></div>
            </div>
            <div class="table-responsive">
      ...
      <div class="col-md-12">
        <div class="box box-danger">
          <div class="box-header with-border">
            <div class="table-responsive">
              <div class="warp-isi" >
                <div> <h4><strong>Detail Penarikan</strong></h4></div>
              </div>
              <div class="table-responsive">
                <table id="example2" class=" table table-bordered table-hover  dataTable dataAdmin">
                  <thead>
                    <tr role="row">
                      <th>No</th>
                      <th>Tanggal</th>
